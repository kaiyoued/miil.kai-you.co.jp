<template>
  <div class="main-contents">
    ...
    <div class="about" id="about">
      ...
      <div class="about__wrapper">
        ...
        <div class="about__txt">
          <h2>About</h2>
          <h3>既存の概念を削ぎ落とし、<br>新たな価値を創出する</h3>
          <p>MILLは2021年7月に発足したデザインスタジオです。
            Web構築をはじめとするUI設計、施作提案やCI・VI、ビジュアルデザイン、プロモーションムービーを含む撮影・編集業務をメインにお客様のブランディングを包括的にディレクションいたします。<br><br>
            お客様のかけがえのないブランドの魅力を多角的に観察し、新しい見え方やより研鑽された姿をご提案いたします。</p>
        </div>
      </div>
    </div>
    ...
    <div class="contact" id="contact">
      <h2>Contact</h2>
      <p class="contact__subhead">お仕事・お見積りのご依頼、お問い合わせ、その他ご相談を承ります。<br>お問い合わせ内容を確認後、追って担当者よりご連絡致します。<br>また、*は必須入力項目となりますのでご注意くださいませ。</p>
      <div class="contact__wrapper">
        <form action="https://docs.google.com/forms/u/2/d/e/1FAIpQLSfmUwSc9cgSROpla2tkqJdvszMk2i2RRqfUBY0k8-qCWud8AQ/formResponse?embedded=true" target="_self" method="POST" id="mG61Hd">
          <ul>
            <li>
              <p><label>お名前<span>*</span></label><input name="entry.74003641" type="text" required="required"></p>
            </li>
            <li>
              <p><label>フリガナ</label><input name="entry.1761268126" type="text"></p>
            </li>
            <li>
              <p><label>メールアドレス<span>*</span></label><input name="entry.512372721" type="text" required="required"></p>
            </li>
            <li>
              <p><label>電話番号</label><input name="entry.1699481110" type="text"></p>
            </li>
            <li>
              <p><label>貴社名</label><input name="entry.1352871323" type="text"></p>
            </li>
            <li>
              <p><label>お問い合わせ内容<span>*</span></label><textarea name="entry.1448909141" id="" cols="30" rows="4" required="required"></textarea></p>
            </li>
          </ul>
